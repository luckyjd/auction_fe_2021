<template>
  ...
  <!--        </b-carousel-slide>-->
    ...
    <div class="auction-info-wrapper col-12 p-0 d-flex justify-content-center">
      ...
      <div class="auction-notification col-3 p-2">
        <div class="row row-no-margin">
          <div class="col-12 p-3 font-bold font-16 text-center">Thông báo đấu giá</div>
          ...
          <div class="col-12 p-0 auction-notification-post pb-2">
            <div class="auction-notification-post-single">
              <img src="~@/assets/image/revolution-slider/bg-slide-3.jpg">
              <div class="row row-no-margin font-14 pt-1">
                <div class="text-gray font-regular pt-1">30/10/2020 </div>
                <div class="auction-notification-post-single-title font-bold pt-1">Auction today post title title long long long , so long , so long ,so long </div>
                <div class="auction-notification-post-single-description font-12 pt-1">
    ...
    <div class="auction-info-wrapper col-12 p-0 d-flex justify-content-center">
      <div class="col-9 p-0 pr-4">
        <div class="row row-no-margin auction-today p-3">
          <div class="col-12 p-0">
            <div class="row row-no-margin">
              <div class="col-12 p-0 font-bold font-20 pb-1">Đấu giá sắp diễn ra</div>
              <div class="col-12 p-0 d-flex justify-content-between">
                <div class="font-14 font-medium" style="color: #8A91A1;">8 sản phẩm</div>
                <a class="font-14 font-medium" style="color: #274AF2;">Xem tất cả</a>
              </div>
      ...
      <div class="auction-notification col-3 p-2">
        <div class="row row-no-margin">
          <div class="col-12 p-3 font-bold font-16 text-center">Tin đấu giá mới nhất</div>
          <!-- <div class="font-12 col-12" style="color: #000000;"></div> -->
          <div class="col-12 p-0 auction-notification-post pb-2">
            <div class="auction-notification-post-single">
              <img src="~@/assets/image/revolution-slider/bg-slide-3.jpg">
      ...
      <div class="row row-no-margin auction-news p-3">
        ...
        <div class="col-4 p-0 auction-news-post p-2">
          <div class="auction-news-post-single">
            <img src="~@/assets/image/auction-today-post/img2.png">
            <div class="row row-no-margin font-14 pt-1 pb-1">
              <div class="font-regular text-gray pt-1 pb-1">30/10/2020 </div>
              <div class="auction-news-post-single-title font-bold pt-1 pb-1">Auction today post title title long long long , so long , so long ,so long </div>
              <div class="auction-news-post-single-description pt-1 pb-1">
                Auction today post title description description description description long long long , so long , so long ,so long
                Auction today post title description description description description long long long , so long , so long ,so long
                Auction today post title description description description description long long long , so long , so long ,so long
              </div>
